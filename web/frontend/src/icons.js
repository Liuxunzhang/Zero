/**
 * Inline SVG icon registry (lucide-style 24×24 stroke paths, MIT-licensed
 * path data). Rendered by AppIcon.vue with stroke=currentColor so icons
 * follow the surrounding text color in both themes. No runtime dependency.
 *
 * Values are the *inner* markup of a 24×24 viewBox svg.
 */
export const icons = {
  settings:
